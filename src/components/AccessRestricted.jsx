...
import { canAccessAdminAnalytics, canAccessFarmer, canAccessResearch } from "../auth/access";
    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-50 px-4">
      <div className="max-w-md rounded-2xl border border-slate-200 bg-white p-8 text-center shadow-sm">
        ...
        <h1 className="mt-2 text-2xl font-black text-slate-900">
          {RESEARCH_WORKSPACE_ENABLED ? "Research Mode is protected" : "This account has no access"}
        </h1>
        <p className="mt-3 text-sm text-slate-500">
          {RESEARCH_WORKSPACE_ENABLED
            ? "This section is only available to admin, researcher, supervisor, and field officer roles."
            : "Sign in with a farmer account to continue."}
        </p>
