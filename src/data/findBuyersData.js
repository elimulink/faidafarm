...
export const buyers = [
  ...
  },
  {
    id: "byr-009",
    channel: "marikiti",
    name: "Marikiti (Wakulima) traders",
    type: "Market trader",
    town: "Nairobi",
    county: "Nairobi",
    distanceKm: 180,
    crops: ["Ndengu", "Cowpeas", "Maize", "Beans"],
    offerPerKg: 85,
    demand: "High",
    verification: "verified",
    rating: 4.4,
...
// Where the sale happens. A local buyer usually collects, so the farmer pays
// nothing to reach them; a Marikiti buyer pays more per kilo but the farmer
// carries the load there, which is the whole comparison this page exists for.
export const BUYER_CHANNELS = [
  { id: "local", label: "Local", blurb: "Near your farm, usually collects" },
  { id: "marikiti", label: "Marikiti", blurb: "City market, you deliver" },
];
